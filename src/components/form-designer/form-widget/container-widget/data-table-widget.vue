<template>
	<container-wrapper :designer="designer" :widget="widget" :parent-widget="parentWidget" :parent-list="parentList"
		...
		<div class="collapse-container" :class="{ 'selected': selected }" @click.stop="selectWidget(widget)">

			<el-table :data="widget.options.tableData" ref="dataTable" :class="[customClass]" :height="tableHeight"
				...
				@click.native.stop="selectWidget(widget)" :stripe="widget.options.stripe" @select="handleRowSelect"
				@select-all="handleAllSelect" :cell-style="{ padding: widget.options.rowSpacing + 'px 0' }">
				...
				<el-table-column v-for="(item, index) in widget.options.tableColumns" v-if="item.show !== false" :key="index"
					...
					:format="item.format" :show-overflow-tooltip="true" :width="item.width">
				</el-table-column>
			...
			<el-pagination v-if="widget.options.showPagination" :small="widget.options.smallPagination"
				:current-page="widget.options.pagination.currentPage" :page-sizes="widget.options.pagination.pageSizes"
				:page-size="widget.options.pagination.pageSize" :layout="paginationLayout"
...
console.log('.../././././');
// import FieldComponents  from console.log('.../././././');'@/components/form-designer/form-widget/field-widget/index'
