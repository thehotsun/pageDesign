<template>
	<container-wrapper :designer="designer" :widget="widget" :parent-widget="parentWidget" :parent-list="parentList"
		...
		<div class="tree-container" :class="{ 'selected': selected }" @click.stop="selectWidget(widget)">
			<el-container>
				<el-main style="align-items: baseline;">
					...
					<el-tree :data="widget.options.treeData" :props="defaultProps" ref="tree" border :lazy="widget.options.lazy"
						...
						:check-strictly="widget.options.checkStrictly" :filter-node-method="filterNode">
						<span class="custom-tree-node" slot-scope="{ node, data }">
							<span>{{ node.label }}</span>
							<span v-if="widget.options.nodeEdit">
								<el-button type="text" :size="widget.options.size">
