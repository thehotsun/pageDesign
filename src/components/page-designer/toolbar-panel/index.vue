<template>
  <div class="toolbar-container">
    ...
    <el-drawer :title="i18nt('designer.toolbar.nodeTreeTitle')" direction="ltr" :visible.sync="showNodeTreeDrawerFlag"
      :modal="false" :size="280" append-to-body :destroy-on-close="true" class="node-tree-drawer">
    ...
    <el-dialog :title="i18nt('designer.toolbar.preview')" :visible.sync="showPreviewDialogFlag"
      ...
      <div>
        <div class="form-render-wrapper"
          ...
          <pageRender ref="preForm" :form-json="formJson" :form-data="testFormData" :preview-state="true"
            :option-data="testOptionData" :global-dsv="designerDsv" @appendButtonClick="testOnAppendButtonClick"
            @buttonClick="testOnButtonClick" @dataTableSelectionChange="testDTSC" :disabled-mode="false"
    ...
    <el-dialog :title="i18nt('designer.toolbar.exportCode')" :visible.sync="showExportCodeDialogFlag" append-to-body
      v-if="showExportCodeDialogFlag" :show-close="true" class="small-padding-dialog" center v-dialog-drag width="65%"
      :close-on-click-modal="false" :close-on-press-escape="false" :destroy-on-close="true">
    ...
    <el-dialog :title="i18nt('designer.toolbar.generateSFC')" :visible.sync="showExportSFCDialogFlag" append-to-body
      v-if="showExportSFCDialogFlag" :show-close="true" class="small-padding-dialog" center v-dialog-drag width="65%"
      :close-on-click-modal="false" :close-on-press-escape="false" :destroy-on-close="true">
