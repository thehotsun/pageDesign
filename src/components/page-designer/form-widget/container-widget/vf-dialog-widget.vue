<template>
  <container-wrapper :designer="designer" :widget="widget" :parent-widget="parentWidget" :parent-list="parentList"
    ...
    <div class="dialog-container" :class="[selected ? 'selected' : '', customClass]" @click.stop="selectWidget(widget)">
      <draggable :list="widget.widgetList" v-bind="{ group: 'dragGroup', ghostClass: 'ghost', animation: 200 }"
        ...
        @add="(evt) => onDialogDragAdd(evt, widget.widgetList)" @update="onDialogDragUpdate" :move="checkContainerMove">
        <transition-group name="fade" tag="div" class="vf-dialog-drop-zone">
