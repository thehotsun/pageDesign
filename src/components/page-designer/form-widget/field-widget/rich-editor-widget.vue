<template>
  <form-item-wrapper :designer="designer" :field="field" :rules="rules" :design-state="designState"
    ...
    <vue-editor ref="fieldEditor" v-model="fieldModel" :editor-toolbar="customToolbar"
      :class="{ 'readonly-mode-rich-editor': isReadMode }" :disabled="field.options.disabled || isReadMode"
      :placeholder="field.options.placeholder" @text-change="handleRichEditorChangeEvent"
