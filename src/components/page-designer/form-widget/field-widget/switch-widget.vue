<template>
  <form-item-wrapper :designer="designer" :field="field" :rules="rules" :design-state="designState"
    ...
    <el-switch ref="fieldEditor" v-model="fieldModel" v-show="!isReadMode" :disabled="field.options.disabled"
      ...
      :width="field.options.switchWidth" @change="handleChangeEvent">
    </el-switch>
