...
export const addZHExtensionLang = (zhLang) => {
  if (!!zhLang.extension && !!zhLang.extension.widgetLabel) {
    overwriteObj(
      zhLocale_extension.extension.widgetLabel,
      zhLang.extension.widgetLabel
    );
  }

  if (!!zhLang.extension && !!zhLang.extension.setting) {
    overwriteObj(
      zhLocale_extension.extension.setting,
      zhLang.extension.setting
    );
  }
};
...
export const addENExtensionLang = (enLang) => {
  if (!!enLang.extension && !!enLang.extension.widgetLabel) {
    overwriteObj(
      enLocale_extension.extension.widgetLabel,
      enLang.extension.widgetLabel
    );
  }

  if (!!enLang.extension && !!enLang.extension.setting) {
    overwriteObj(
      enLocale_extension.extension.setting,
      enLang.extension.setting
    );
  }
};
